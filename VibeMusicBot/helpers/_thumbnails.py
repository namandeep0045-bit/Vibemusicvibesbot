...
from VibeMusicBot import config
from VibeMusicBot.helpers import Track
...
class Thumbnail:
    def __init__(self):
        try:
            self.title_font = ImageFont.truetype("VibeMusicBot/helpers/Raleway-Bold.ttf", 32)
            self.regular_font = ImageFont.truetype("VibeMusicBot/helpers/Inter-Light.ttf", 18)
        except OSError:
    ...
    def _generate_sync(self, temp: str, output: str, song: Track, size=(1280, 720)) -> str:
        try:
            ...
            draw.text((TITLE_X, TITLE_Y), trim_to_width(clean_title, self.title_font, MAX_TITLE_WIDTH),
            ...
            icons_path = "VibeMusicBot/helpers/play_icons.png"
